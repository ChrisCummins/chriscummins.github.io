...
THREE.OrbitControls = function (object, domElement) {
  ...
  this.pan = function (deltaX, deltaY) {
    ...
    if (scope.object.fov !== undefined) {
      ...
      // orthographic
      scope.panLeft(deltaX * (scope.object.right - scope.object.left)
          / element.clientWidth);
      scope.panUp(deltaY * (scope.object.top - scope.object.bottom)
  ...
  function onKeyDown(event) {
    ...
    if (scope.enabled === false || scope.noKeys === true || scope.noPan
        === true) {
      return;
    }
