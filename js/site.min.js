$(document).ready(function(){for(var a=document.getElementsByTagName("code"),d=0;d<a.length;d++)a[d].innerHTML=a[d].innerHTML.replace(/^\s*\n/,"");a=document.links;for(d=0;d<a.length;d++)a[d].hostname!=window.location.hostname&&(a[d].target="_blank")});var metas=document.getElementsByTagName("meta"),i;
