$(document).ready(function(){$("code").each(function(b){$(this).html($(this).html().replace(/^\s*\n/,""))});$("a").each(function(b){b=$(this)[0];b.hostname!=window.location.hostname&&(b.target="_blank",b.title="Link opens in new window")})});var metas=document.getElementsByTagName("meta"),i;
...
e})();jQuery(function(b){b("section p, section p a").hyphenate("en-gb")});
