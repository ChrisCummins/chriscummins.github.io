$(document).ready(function(){$("a").each(function(b){b=$(this)[0];b.hostname!=window.location.hostname&&(b.target="_blank",b.title="Link opens in new window")});$("section p, section p a").hyphenate("en-gb");$("section code").each(function(b){$(this).html($(this).html().replace(/^\s*\n/,""))});$("section img").each(function(b){$(this).wrap('<a href="'+$(this).attr("src")+'" title="Click to see original" target="_blank"></a>')})});var metas=document.getElementsByTagName("meta"),i;
