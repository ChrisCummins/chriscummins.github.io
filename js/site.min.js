$(document).ready(function(){$("a").each(function(a){a=$(this)[0];a.hostname&&a.hostname!=window.location.hostname&&(a.target="_blank",a.title="Link opens in new window")});var c=$("#hidden-title"),d=$("h1.title"),b=d.width(),e=parseInt(d.css("font-size")),a=0;c.text(d.text());if(c.width()>b){do{c.css({fontSize:e});var n=b/c.width(),e=e*n;a++}while(c.width()>b&&10>a);d.css({fontSize:e})}c=function(){var a=$(window).width(),b=960>a?-40:0,d=1,e=$(window).scrollLeft();890<a&&(b-=1.015*e,d-=0.005*e);
$("header,footer").css("margin-left",b+"px");$("header,footer").css("opacity",d);890>a&&$("header,footer").removeAttr("style")};$(window).ready(c);$(window).resize(c);$(window).scroll(c);$("section p, section p a").hyphenate("en-gb");$("section code").each(function(a){$(this).html($(this).html().replace(/^\s*\n/,""))});$("section img").each(function(a){$(this).parent().is("a")||$(this).wrap('<a href="'+$(this).attr("src")+'" title="Click to see original" target="_blank"></a>')})});
